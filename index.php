...
<div class="banner-top">
			...
			<div class="contact-bnr-w3-agile">
				<ul>
					<li><i class="fa fa-envelope" aria-hidden="true"></i><a href="mailto:info@example.com">INFO@VILLA.COM</a></li>
		...
		<div class="container">
			<nav class="navbar navbar-default">
				<div class="navbar-header navbar-left">
					...
					<h1><a class="navbar-brand" href="index.php">VILLA <span>VEDHAPURI</span><p class="logo_w3l_agile_caption">Your Dreamy Resort</p></a></h1>
				</div>
							...
							<!-- Modal content-->
								<div class="modal-content">
									<div class="modal-header">
										...
										<h4>VILLA  <span>VEDHAPURI</span></h4>
				...
				<ul class="cbp-ig-grid">
					<li>
						<div class="w3_grid_effect">
							...
							<span class="cbp-ig-category">VILLA</span>
						</div>
					</li>
					<li>
						<div class="w3_grid_effect">
 	...
 	<div class="about-wthree" id="about">
		  <div class="container">
				   <div class="ab-w3l-spa">
                            <h3 class="title-w3-agileits title-black-wthree">About Our VILLA</h3> 
...
<section class="contact-w3ls" id="contact">
	<div class="container">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<p class="contact-agile1"><strong>Phone :</strong>+91 8925123386</p>
			<p class="contact-agile1"><strong>Email :</strong> <a href="mailto:name@example.com">Prabhu@VILLA.COM</a></p>
			<p class="contact-agile1"><strong>Address :</strong> Beach Road, Batticaloa, CHENNAI</p>
...
<!-- /contact -->
			<div class="copy">
		        <p>© 2017 villa . All Rights Reserved | Design by <a href="index.php">Villa Vedhapuri</a> </p>
		    </div>
<!--/footer -->
<!-- js -->
